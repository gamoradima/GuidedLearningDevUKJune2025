define("UsrRealty_ListPage", /**SCHEMA_DEPS*/[]/**SCHEMA_DEPS*/, function/**SCHEMA_ARGS*/()/**SCHEMA_ARGS*/ {
	return {
		viewConfigDiff: /**SCHEMA_VIEW_CONFIG_DIFF*/[
			...
			{
				"operation": "insert",
				"name": "QuickFilter_awtfbwu",
				"values": {
					"type": "crt.QuickFilter",
					"config": {
						"caption": "#ResourceString(QuickFilter_awtfbwu_config_caption)#",
						"hint": "",
					...
					"_filterOptions": {
						"expose": [
							{
								"attribute": "QuickFilter_awtfbwu_Items",
								"converters": [
									{
						...
						"from": "QuickFilter_awtfbwu_Value"
					},
					"filterType": "lookup"
				},
			...
			},
			{
				...
				"values": {
					"filterAttributes": [
						...
						{
							"name": "QuickFilter_awtfbwu_Items",
							"loadOnChange": true
						}
					]
				}
