define("UsrRealty_FormPage", /**SCHEMA_DEPS*/["@creatio-devkit/common"]/**SCHEMA_DEPS*/, function/**SCHEMA_ARGS*/(sdk)/**SCHEMA_ARGS*/ {
	return {
		viewConfigDiff: /**SCHEMA_VIEW_CONFIG_DIFF*/[
			...
			{
				"operation": "insert",
				"name": "StartProcessAvgPriceMenuItem",
				"values": {
					"type": "crt.MenuItem",
					"caption": "#ResourceString(StartProcessAvgPriceMenuItem_caption)#",
					"visible": true,
					"clicked": {
		...
		handlers: /**SCHEMA_HANDLERS*/[
			...
			},
			{
				...
				handler: async (request, next) => {
					...
					var typeObject = await request.$context.PDS_UsrType_577begf;
					var typeId = "";
					if (typeObject) {
					...
					var offerTypeObject = await request.$context.PDS_UsrOfferType_eg15tm8;
					var offerTypeId = "";
					if (offerTypeObject) {
